...
export const MancalaBoardModelsQuery = gql`
  query mancalaChiMancalaBoardModels {
    mancalaChiMancalaBoardModels {
      edges {
        node {
          game_id
          player_one
...
export const MancalaBoardModelQuery = gql`
  query mancalaChiMancalaBoardModels($gameId: u128) {
    mancalaChiMancalaBoardModels(
...
export const MancalaPlayQuery = gql`
  query mancalaChiPlayerModels($gameId: u128) {
    mancalaChiPlayerModels(where: { game_id: $gameId }, limit: 1000000000) {
      edges {
        node {
          address
          game_id
    ...
    mancalaChiPitModels(where: { game_id: $gameId }, limit: 1000000000) {
      edges {
        node {
          game_id
          player
...
export const MancalaSeedQuery = gql`
  query mancalaChiSeedModels($gameId: u128) {
    mancalaChiSeedModels(where: { game_id: $gameId }, limit: 1000000000) {
      edges {
        node {
          game_id
          pit_number
...
export const MancalaHeaderQuery = gql`
  query FetchModelsForHeader {
    mancalaChiGameModels(limit: 1000000000) {
      edges {
        node {
          game_id
          player_one
...
export const MancalaPlayerNames = gql`
  query mancalaChiPlayerNames {
    mancalaChiProfileModels(limit: 1000000000) {
      edges {
        node {
          name
          address
...
export const MancalaCaptureQuery = gql`
  query mancalaChiCaptureModels($gameId: u128) {
    mancalaChiCaptureModels(where: { game_id: $gameId }, limit: 1000000000) {
      edges {
        node {
          game_id
          player
...
export const MancalaExtraTurnQuery = gql`
  query mancalaChiPlayerExtraTurnModels($gameId: u128) {
    mancalaChiPlayerExtraTurnModels(
      where: { game_id: $gameId }
      limit: 1000000000
    ) {
      edges {
