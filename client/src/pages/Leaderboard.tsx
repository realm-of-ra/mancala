            ...
            <div className="flex flex-row justify-between flex-1 w-full">
              ...
              <div className="flex flex-col items-center justify-center space-y-1.5 relative mt-10">
                ...
                <h3 className="text-2xl text-white">
                  {profiles[1]?.name
                    ? profiles[1].name
                    : addresses && truncateString(addresses[1])}
                </h3>
                <div className="flex flex-row space-x-0.5">
                  <div className="bg-[url('./assets/cup.png')] w-4 h-4 bg-cover bg-no-repeat" />
                  <h4 className="text-xs text-[#F58229]">
                    {(players && players[1]?.wins !== undefined
                      ? players[1].wins
                      : 0) * 50}{" "}
                    points
                  </h4>
              ...
              <div className="flex flex-col items-center -mt-48">
                ...
                <div className="flex flex-col items-center justify-center space-y-1.5 absolute top-[250px]">
                  ...
                  <h3 className="text-2xl text-white">
                    {profiles[0]?.name
                      ? profiles[2].name
                      : addresses && truncateString(addresses[0])}
                  </h3>
                  <div className="flex flex-row space-x-0.5">
                    <div className="bg-[url('./assets/cup.png')] w-4 h-4 bg-cover bg-no-repeat" />
                    <h4 className="text-xs text-[#F58229]">
                      {(players && players[0]?.wins !== undefined
                        ? players[0].wins
                        : 0) * 50}{" "}
                      points
                    </h4>
              ...
              <div className="flex flex-col items-center justify-center space-y-1.5 mt-10">
                ...
                <h3 className="text-2xl text-white">
                  {profiles[2]?.name
                    ? profiles[2].name
                    : addresses && truncateString(addresses[2])}
                </h3>
                <div className="flex flex-row space-x-0.5">
                  <div className="bg-[url('./assets/cup.png')] w-4 h-4 bg-cover bg-no-repeat" />
                  <h4 className="text-xs text-[#F58229]">
                    {(players && players[2]?.wins !== undefined
                      ? players[2].wins
                      : 0) * 50}{" "}
                    points
                  </h4>
                      ...
                      <tr key={index}>
                        <td
                          className={clsx(
                            ...
                            "flex flex-row items-center p-4 space-x-5 w-full",
                          )}
                        >
