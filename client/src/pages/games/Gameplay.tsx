...
export default function Gameplay() {
	...
	return (
		<main className="min-h-screen w-full bg-[#0F1116] flex flex-col items-center overflow-y-scroll">
			<nav className="relative w-full h-[120px]">
			...
			<div className="w-full flex justify-between items-center max-w-7xl  px-[300px]">
				<div className=" bg-[url('./assets/score-value.svg')] h-[80px] w-[90px] bg-cover bg-center bg-no-repeat">
					<div className="h-full flex items-center justify-center">
						<p className="text-4xl text-white">8</p>
					</div>
				</div>
				<div className=" bg-[url('./assets/score-value.svg')] h-[80px] w-[90px] bg-cover bg-center bg-no-repeat">
					<div className="h-full flex items-center justify-center">
				...
				<div className="flex-1 w-full h-full">
					...
					<div className="w-full h-[400px] border-2 border-[#32363D] rounded-l-full rounded-r-full flex flex-col items-center justify-center bg-[#15181E] mt-24">
						<div className="w-[97%] h-[370px] rounded-l-full rounded-r-full flex flex-row items-center justify-between space-x-5 relative">
							<div className="w-56 h-[350px] border-[3px] border-[#3A3E49] rounded-l-[165px] rounded-r-3xl relative">
								{/* Player 1 pot */}
							...
							<div className="w-56 h-[350px] border-[3px] border-[#3A3E49] rounded-r-[165px] relative rounded-l-3xl">
								{/* Player 2 pot */}
