...
const StarknetGameBoard: React.FC<GameBoardProps> = ({
  game_players,
  game_node,
  system,
  account,
  ...
  return (
    <div className="w-full h-[400px] flex flex-col items-center justify-center mt-24">
      <div className="w-[1170px] h-[400px] flex flex-row items-center justify-between space-x-5 relative bg-[url('./assets/starknet-board.png')] bg-contain bg-center bg-no-repeat">
...
export default StarknetGameBoard;