    ...
    <div className="w-full h-[400px] flex flex-col items-center justify-center mt-24">
      <div className="w-[1170px] h-[400px] flex flex-row items-center justify-between space-x-5 relative bg-[url('./assets/game_board.png')] bg-contain bg-center bg-no-repeat">
        <div className="w-fit h-[220px] mt-14 relative">
          ...
          <Seed color="Blue" length={4} type="opponent" seed_id={25} pit_number={6} seed_number={25} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={26} pit_number={6} seed_number={26} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={27} pit_number={6} seed_number={27} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={28} pit_number={6} seed_number={28} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={29} pit_number={6} seed_number={29} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={30} pit_number={6} seed_number={30} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={31} pit_number={6} seed_number={31} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={32} pit_number={6} seed_number={32} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={33} pit_number={6} seed_number={33} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={34} pit_number={6} seed_number={34} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={35} pit_number={6} seed_number={35} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={36} pit_number={6} seed_number={36} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={37} pit_number={6} seed_number={37} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={38} pit_number={6} seed_number={38} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={39} pit_number={6} seed_number={39} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={40} pit_number={6} seed_number={40} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={41} pit_number={6} seed_number={41} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={42} pit_number={6} seed_number={42} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={43} pit_number={6} seed_number={43} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={44} pit_number={6} seed_number={44} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={45} pit_number={6} seed_number={45} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={46} pit_number={6} seed_number={46} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={47} pit_number={6} seed_number={47} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={48} pit_number={6} seed_number={48} isNative={true} />
          <div
            className={
