    ...
    <div className="w-full h-[400px] flex flex-col items-center justify-center mt-24">
      <div className="w-[1170px] h-[400px] flex flex-row items-center justify-between space-x-5 relative bg-[url('./assets/game_board.png')] bg-contain bg-center bg-no-repeat">
        <div className="w-fit h-[220px] mt-14 relative">
          ...
          <Seed color="Green" length={4} type="opponent" seed_id={1} pit_number={7} seed_number={1} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={2} pit_number={7} seed_number={2} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={3} pit_number={7} seed_number={3} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={4} pit_number={7} seed_number={4} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={5} pit_number={7} seed_number={5} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={6} pit_number={7} seed_number={6} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={7} pit_number={7} seed_number={7} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={8} pit_number={7} seed_number={8} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={9} pit_number={7} seed_number={9} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={10} pit_number={7} seed_number={10} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={11} pit_number={7} seed_number={11} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={12} pit_number={7} seed_number={12} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={13} pit_number={7} seed_number={13} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={14} pit_number={7} seed_number={14} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={15} pit_number={7} seed_number={15} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={16} pit_number={7} seed_number={16} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={17} pit_number={7} seed_number={17} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={18} pit_number={7} seed_number={18} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={19} pit_number={7} seed_number={19} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={20} pit_number={7} seed_number={20} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={21} pit_number={7} seed_number={21} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={22} pit_number={7} seed_number={22} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={23} pit_number={7} seed_number={23} isNative={true} />
          <Seed color="Green" length={4} type="opponent" seed_id={24} pit_number={7} seed_number={24} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={25} pit_number={7} seed_number={25} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={26} pit_number={7} seed_number={26} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={27} pit_number={7} seed_number={27} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={28} pit_number={7} seed_number={28} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={29} pit_number={7} seed_number={29} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={30} pit_number={7} seed_number={30} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={31} pit_number={7} seed_number={31} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={32} pit_number={7} seed_number={32} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={33} pit_number={7} seed_number={33} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={34} pit_number={7} seed_number={34} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={35} pit_number={7} seed_number={35} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={36} pit_number={7} seed_number={36} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={37} pit_number={7} seed_number={37} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={38} pit_number={7} seed_number={38} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={39} pit_number={7} seed_number={39} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={40} pit_number={7} seed_number={40} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={41} pit_number={7} seed_number={41} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={42} pit_number={7} seed_number={42} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={43} pit_number={7} seed_number={43} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={44} pit_number={7} seed_number={44} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={45} pit_number={7} seed_number={45} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={46} pit_number={7} seed_number={46} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={47} pit_number={7} seed_number={47} isNative={true} />
          <Seed color="Blue" length={4} type="opponent" seed_id={48} pit_number={7} seed_number={48} isNative={true} />
          <div
            className={
