            ...
            <div className="flex flex-row space-x-2.5 items-center justify-end">
              ...
              <div>
                ...
                <h4 className="text-sm text-[#F58229] text-start">
                  {player?.[0]?.wins < 4 ? "Level 1" : `Level ${player?.[0]?.wins < 4 ? 1 : (Math.floor(player?.[0]?.wins / 4) + 1)}`}
                </h4>
              </div>
            </div>
          ) : (
              ...
              <div className="relative">
                <Button
                  ...
                  <div className="flex w-[259px] flex-row items-center">
                    ...
                    <ChevronDownIcon
                      className={
                        clsx(connection?.isConnected ? "text-[#C7CAD4]" : "text-[#FCE3AA]", "w-4 h-4 ml-3 transition duration-300",
                ...
                {isDropdownClose && (
                  <div 
                    className="absolute top-1/2 font-medium transform translate-y-6 w-[259px] right-0 mt-2 border border-[#272A32] bg-[#171922] text-[#BFC5D4] rounded-xl shadow-xl z-20">
