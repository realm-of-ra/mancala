...
export default function Header() {
  ...
  useEffect(() => {
    const profile: any = playerData?.mancalaKefirProfileModels?.edges.find(
  ...
  }, [account, playerData?.mancalaKefirProfileModels?.edges, playerData]);
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      const userExists = profiles.mancalaKefirProfileModels.edges.some(
  ...
  useEffect(() => {
    if (
      account?.address &&
      playerData?.mancalaKefirProfileModels?.edges &&
      !profile
    ) {
      setOpen(true);
    }
