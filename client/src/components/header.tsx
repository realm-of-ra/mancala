...
export default function Header() {
  ...
  useEffect(() => {
    const profile: any = playerData?.mancalaAvalonProfileModels?.edges.find(
  ...
  }, [account, playerData?.mancalaAvalonProfileModels?.edges, playerData]);
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      const userExists = profiles.mancalaAvalonProfileModels.edges.some(
  ...
  useEffect(() => {
    if (
      account?.address &&
      playerData?.mancalaAvalonProfileModels?.edges &&
      !profile
    ) {
      setOpen(true);
    }
      ...
      <div className="flex-1 w-full relative">
        <div className="flex flex-row space-x-2.5 items-center justify-start absolute right-10 -top-6">
          ...
          <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent className="bg-[#171922] hover:bg-[#171922] border-none text-[#BFC5D4] w-40 pr-1.5 space-y-1">
              {account?.address && (
                <DropdownMenuItem
                  className="flex flex-col items-start justify-start hover:bg-[#171922] bg-[#171922] px-0 font-medium space-y-1"
                  disabled
                >
                  <p className="px-1.5">Account</p>
                  <div
                    className="mx-1 w-full pr-1.5 hover:cursor-pointer"
                  ...
                  <div className="bg-[#111419] mx-1 p-2 rounded-md flex flex-row items-center justify-start space-x-1">
                    <p>
                      {error ? "0.00" : balanceData?.formatted}{" "}
                      {balanceData?.symbol}
                    </p>
              ...
              <DropdownMenuItem
                className="flex flex-col items-start justify-start hover:bg-[#171922] bg-[#171922] p-0 font-medium"
                disabled
              >
                <p className="px-1.5">Sounds</p>
              </DropdownMenuItem>
              <DropdownMenuItem
                className="flex flex-col items-start justify-start hover:bg-[#191b23] bg-[#171922] p-0 font-medium"
                disabled
              >
              ...
              <DropdownMenuItem
                className="flex flex-col items-start justify-start hover:bg-[#191b23] bg-[#171922] px-0 font-medium"
                onClick={account?.address ? disconnectWallet : connectWallet}
              >
            ...
            <div className="space-y-5">
              <div className="space-y-5 flex flex-col justify-center">
                <div className="space-y-2.5">
                  <h6 className="text-xl text-white font-bold">Display Name</h6>
                ...
                <div className="flex flex-row items-center justify-between space-x-5">
                  <div className="space-y-2.5">
                    ...
                    >
                      <img src={image} width={20} height={20} alt="add photo" />
                      <input
                        type="file"
                        className="hidden"
                        ref={fileInputRef}
                  ...
                  <img
                    src={
                      selectedImage === "#" ? avatar : selectedImage || avatar
                    }
                    width={100}
                    height={100}
                ...
                <div className="space-y-4">
                    ...
                    <div
                      className={clsx(
                        ...
                        saveStatus.status === "saving" &&
                          "bg-transparent border-2 border-[#4B505C] text-[#4B505C]",
                  ...
                  <div className="w-full flex flex-row items-center justify-center space-x-4">
                    <button
                      className={
                        "py-1.5 rounded-lg font-semibold w-52 bg-[#F58229] text-[#FCE3AA] hover:bg-[#E47218]"
                      }
